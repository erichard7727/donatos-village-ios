...
// Adapted from: https://raw.githubusercontent.com/seedco/StackViewController/master/StackViewController/AutoScrollView.swift
...
open class KeyboardAwareScrollView: UIScrollView {
    ...
    fileprivate func commonInit() {
        ...
        nc.addObserver(self, selector: #selector(KeyboardAwareScrollView.keyboardWillShow(_:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        nc.addObserver(self, selector: #selector(KeyboardAwareScrollView.keyboardWillHide(_:)), name: UIResponder.keyboardWillHideNotification, object: nil)
    }
